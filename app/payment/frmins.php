...
<div class="col-12 container-fluid">
  <div class="row">
    <div class="col-8">
      ...
      <button type="button" class="btn btn-outline-light"><a class="text-muted" href="main.php?folder=app/future-payments/&file=library.php">Visualizar futuras entradas</a></button>
    </div>
    <div class="col-4">
