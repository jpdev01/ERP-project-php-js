...
if ($category) {
  $filtros[] = " `categorias_id` = '{$category}'";
}
if ($provider) {
  $filtros[] = " `fornecedores_id` = '{$provider}'";
}

else if ($status == "todos" || isset($status)){
...
<div class='table-responsive'>
  <table id='employee_table' class='table table-sm table-striped'>
    ...
    <tbody>
      ...
      ?>
        <tr onclick="conteudo('#div-card', 'products', 'focus', '<?php echo $product['id']; ?>')">
